...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/elesssss/s-ui/main/install.sh"
...
update_shell() {
    wget -O /usr/bin/s-ui -N --no-check-certificate https://github.com/elesssss/s-ui/raw/main/s-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
